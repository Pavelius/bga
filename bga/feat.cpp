...
BSDATA(feati) = {
	...
	{"MartialWeaponBow", FG(GeneralFeat) | FG(FighterFeat), FocusBows},
	{"MartialWeaponFlail", FG(GeneralFeat) | FG(FighterFeat)},
	{"MartialWeaponGreatSword", FG(GeneralFeat) | FG(FighterFeat), FocusGreatSwords},
	...
	{"FocusBows", FG(GeneralFeat) | FG(FighterFeat)},
	...
	{"FocusGreatSwords", FG(GeneralFeat) | FG(FighterFeat)},
