...
enum resn : unsigned short {
	NONE,
	STONEBIG, REALMS, NORMAL, TOOLFONT, NUMBER, TEST,
	CURSORS, CURSARW, COLGRAD, COLOR, TOOLTIP,
	GACTN,
	GBTNBFRM, GBTNJBTN, GBTNLRG, GBTNMED, GBTNMED2, GBTNMINS, GBTNPLUS, GBTNOPT1, GBTNOPT2, GBTNOPT3, GUISLDR,
	...
	GUIACG, GUIBTACT, GUIBTBUT,
	GUICGB, GUICHP, GUIHELP, GUIINV,
	GIITMH08, GUIHSB, GUICARBB, GUISTDRB,
	GUIPFC, GUIRSPOR, GUISPL, GUICNAME, GUIERR,
